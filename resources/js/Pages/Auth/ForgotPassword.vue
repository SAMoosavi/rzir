<template>
    ...
    <jet-authentication-card>
        ...
        <div class="mb-4 text-lg text-justify text-gray-600 dark:text-white">
        ...
        <form @submit.prevent="submit">
            <div>
                ...
                <jet-input id="email" type="email" classItem="block w-full mt-1 text-left" v-model="form.email" />
            </div>
